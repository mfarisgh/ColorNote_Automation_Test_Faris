...
'Tap and hold a note from home page | Parameterized noteText'
Mobile.tapAndHold(findTestObject('ColorNote-DeleteNote/homePage_NoteList', [('noteText') : noteText]), 0, 0)
...
'Verify note deleted from home page | Parameterized noteText'
Mobile.verifyElementNotExist(findTestObject('ColorNote-DeleteNote/homePage_NoteList', [('noteText') : noteText]), 0)
...
'Verify deleted note exist in trash can | Parameterized noteText'
Mobile.verifyElementExist(findTestObject('ColorNote-DeleteNote/trashNote_NoteList', [('noteText') : noteText]), 0)
